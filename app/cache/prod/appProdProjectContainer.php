...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'ogis_user.user_registration' => 'getOgisUser_UserRegistrationService',
            ...
            'swiftmailer.mailer.plugin.antiflood' => 'getSwiftmailer_Mailer_Plugin_AntifloodService',
    ...
    {
        return $this->services['assetic.helper.static'] = new \Symfony\Bundle\AsseticBundle\Templating\StaticAsseticHelper($this->get('assets.packages'), $this->get('assetic.asset_factory'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => 'localhost', 'port' => 5432, 'dbname' => 'ogis', 'user' => 'postgres', 'password' => 12345, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\OGIS\\IndexBundle\\Entity'))), 'OGIS\\IndexBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('OGISIndexBundle' => 'OGIS\\IndexBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_9fd0d081bc6bb3cd4213e9f567a546f43aa291993fbd751783c065c42cfe4a5e');
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addSubscriberService('ogis_user.user_registration', 'OGIS\\IndexBundle\\EventListener\\UserExtraFieldAssignmentListener');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('OGIS\\IndexBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('OGIS\\IndexBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('OGIS\\IndexBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('OGIS\\IndexBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'OGIS\\IndexBundle\\Entity\\User');
    }
    ...
    /*
     * Gets the 'ogis_user.user_registration' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OGIS\IndexBundle\EventListener\UserExtraFieldAssignmentListener A OGIS\IndexBundle\EventListener\UserExtraFieldAssignmentListener instance
     */
    protected function getOgisUser_UserRegistrationService()
    {
        return $this->services['ogis_user.user_registration'] = new \OGIS\IndexBundle\EventListener\UserExtraFieldAssignmentListener($this->get('doctrine.orm.default_entity_manager'), $this->get('security.acl.provider'), $this->get('security.context'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $l->add($k, array(0 => 'IS_AUTHENTICATED_REMEMBERED'), NULL);

        $m = new \Symfony\Component\Security\Http\HttpUtils($d, $d);

        $n = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $m, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($m, 'homepage'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($l, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username')), 'main', $a, $c), 2 => $n, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $m, 'main', $o, $p, array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '583970fa6312f7.93356890', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $l, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $m, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $m, 'fos_user_security_login', false), NULL, NULL, $a, false));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $instance->registerPlugin($this->get('swiftmailer.mailer.plugin.antiflood'));
    ...
    /*
     * Gets the 'swiftmailer.mailer.plugin.antiflood' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Swift_Plugins_AntiFloodPlugin A Swift_Plugins_AntiFloodPlugin instance
     */
    protected function getSwiftmailer_Mailer_Plugin_AntifloodService()
    {
        return $this->services['swiftmailer.mailer.plugin.antiflood'] = new \Swift_Plugins_AntiFloodPlugin(99, 0);
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\OGIS\\IndexBundle/Resources/views'), 'OGISIndex');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ogissystem');
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_PRIV_USER' => array(0 => 'ROLE_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_PRIV_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN'), 'ROLE_SYSTEM' => array(0 => 'ROLE_SUPER_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'OGISIndexBundle' => 'OGIS\\IndexBundle\\OGISIndexBundle',
            ...
            'swiftmailer.mailer.default.antiflood.threshold' => 99,
            'swiftmailer.mailer.default.antiflood.sleep' => 0,
            ...
            'fos_user.model.user.class' => 'OGIS\\IndexBundle\\Entity\\User',
