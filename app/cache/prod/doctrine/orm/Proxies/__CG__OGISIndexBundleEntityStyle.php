 ...
 */
class Style extends \OGIS\IndexBundle\Entity\Style implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'OGIS\\IndexBundle\\Entity\\Style' . "\0" . 'id', '' . "\0" . 'OGIS\\IndexBundle\\Entity\\Style' . "\0" . 'name', '' . "\0" . 'OGIS\\IndexBundle\\Entity\\Style' . "\0" . 'internalname', '' . "\0" . 'OGIS\\IndexBundle\\Entity\\Style' . "\0" . 'author', '' . "\0" . 'OGIS\\IndexBundle\\Entity\\Style' . "\0" . 'data', '' . "\0" . 'OGIS\\IndexBundle\\Entity\\Style' . "\0" . 'type', '' . "\0" . 'OGIS\\IndexBundle\\Entity\\Style' . "\0" . 'description', '' . "\0" . 'OGIS\\IndexBundle\\Entity\\Style' . "\0" . 'created', '' . "\0" . 'OGIS\\IndexBundle\\Entity\\Style' . "\0" . 'modified', '' . "\0" . 'OGIS\\IndexBundle\\Entity\\Style' . "\0" . 'public');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Style $proxy) {
    ...
    public function setInternalname($internalname)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setInternalname', array($internalname));
    ...
    public function getInternalname()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getInternalname', array());
