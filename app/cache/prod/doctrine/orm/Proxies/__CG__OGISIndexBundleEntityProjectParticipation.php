 ...
 */
class ProjectParticipation extends \OGIS\IndexBundle\Entity\ProjectParticipation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'user', 'project', 'rank');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProjectParticipation $proxy) {
