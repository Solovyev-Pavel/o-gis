...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/edit/composition/project')) {
            // altercompositionsharing
            if ($pathinfo === '/edit/composition/project/alter') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_altercompositionsharing;
                }

                return array (  '_controller' => 'OGIS\\IndexBundle\\Controller\\CompositionController::addProjectSharingAction',  '_route' => 'altercompositionsharing',);
            }
            not_altercompositionsharing:

            // removecompositionsharing
            if ($pathinfo === '/edit/composition/project/remove') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_removecompositionsharing;
                }

                return array (  '_controller' => 'OGIS\\IndexBundle\\Controller\\CompositionController::removeProjectSharingAction',  '_route' => 'removecompositionsharing',);
            }
            not_removecompositionsharing:
        ...
        // compositioneditor
        if (0 === strpos($pathinfo, '/ceditor') && preg_match('#^/ceditor(?:/(?P<datasource>[^/]++)(?:/(?P<id>[^/]++))?)?$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'compositioneditor')), array (  '_controller' => 'OGIS\\IndexBundle\\Controller\\EditorController::showCompositionEditorAction',  'datasource' => NULL,  'id' => NULL,));
        }
